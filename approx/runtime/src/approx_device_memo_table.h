...
private:
  ...
  ValType calc_distance(const approx_region_specification &rs, void *input, int size, int entry, int offset)
    {
  ...
  void add_entry(const approx_region_specification *rs, approx_var_ptr_t *inputs, int nInputs)
  {
    int idx_offset = 0;
    int offset = 0;
